...
`pkg/testing` converts a source file into an executable Lab test case. Direct FQL files execute as units. YAML suite files define a query and an assertion, each as inline FQL or a referenced script.
